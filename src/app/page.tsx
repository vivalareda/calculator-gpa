...
export default function Home() {
  return (
    <div className="relative flex h-screen w-screen overflow-hidden bg-red-500">
      <RedRectangle />
      <div className="absolute top-0 right-0 flex h-screen w-full flex-col items-center justify-center bg-gray-50 px-6 pt-10 shadow-xl md:top-0 md:w-3/5 md:px-10">
        <div className="flex flex-col items-center transition-opacity duration-500">
          <h1 className="mb-10 text-center font-bold text-3xl text-gray-800">
          ...
          <div className="grid w-full max-w-4xl gap-6 md:grid-cols-3">
            <Link className="w-full" href="/gpa">
              <div className="group h-full">
                <div className="flex h-full flex-col items-center justify-start gap-4 rounded-xl border border-gray-200 bg-white p-8 pt-12 text-center shadow-sm transition-all hover:border-blue-300 hover:shadow-md">
            ...
            <Link className="w-full" href="/grade-calculator">
              <div className="group h-full">
                <div className="flex h-full flex-col items-center justify-start gap-4 rounded-xl border border-gray-200 bg-white p-8 pt-12 text-center shadow-sm transition-all hover:border-green-300 hover:shadow-md">
            ...
            <Link className="w-full" href="/course-finder">
              <div className="group h-full">
                <div className="flex h-full flex-col items-center justify-start gap-4 rounded-xl border border-gray-200 bg-white p-8 pt-12 text-center shadow-sm transition-all hover:border-purple-300 hover:shadow-md">
